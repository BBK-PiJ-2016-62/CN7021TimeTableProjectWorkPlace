...
public class CheckRoomSizeSufficiencyImpl implements CheckRoomSizeSufficiency {
    ...
    public ArrayList<String> checkRoomSizeSufficiency(ArrayList<ModuleImpl> moduleCodes){
        ...
        ArrayList<ArrayList<String>> roomSizeList = new ExtractRoomDetails().formRoomSizeList();
        ...
        for (ModuleImpl m:moduleCodes){
                ...
                if (as.get(0).trim().toLowerCase().contains("lecture")){
                    ...
                    for(ArrayList<String> rs:roomSizeList) {
                        ...
                        if (itr1.trim().replace(".","").toLowerCase().
                            ...
                            String line1= "  The room "+rs.get(0).trim()+" assigned to this module for "+
                                    rs.get(0).trim()+" can accommodate "+roomSize+" students.";
                            /*System.out.printf("  The room %s assigned to this module for %s can accommodate %d students.\n",
                                    rs.get(0).trim(), as.get(0).toLowerCase(), roomSize);*/
                            System.out.println(line1);
                            roomSizeSufficiencyResult.add(line1);
                            if (m.getStudentNum() <= roomSize) {
                                String line2 = "  The room can accommodate the " + m.getStudentNum() + " students";
                                System.out.println(line2);
                                roomSizeSufficiencyResult.add(line2);
                            } else {
                                String line3 = "  The room is too small for the " + m.getStudentNum() + " students";
                    ...
                    if(rmFound==false) {
                        ...
                        /*System.out.printf("  Either the number of the room (%s) assigned " +
                                        "to this module for %s does not in the room list or no room has been assigned.\n",
            ...
            if (count == 0) {
                ...
                String line4 = "  Number of tutorial/Practical group(s) ("+count+") set is adequate.";
                        ...
                        while (itr.hasNext()) {
                            ...
                            for (ArrayList<String> rs : roomSizeList) {
                                if (itr1.replace(".","").toLowerCase().
                                    ...
                                    String line6 = "  Room "+rs.get(0)+": Size: "+rs.get(1)+" person. Therefore, " +
                            ...
                            if (foundRm == false) {
                                String line7 = "  Either room number ("+itr1+") is not in the room list or no room " +
                                        ...
                                        " cannot proceed further.";
                                /*System.out.printf("  Either room number (%s) is not in the room list or no room " +
                                        "has been assigned to this module, analysis for this module" +
                                        " cannot proceed further.\n", itr1);*/
                        ...
                        if (!m.getTypeOfMeetingNRmNumList().get(i).get(0).trim().toLowerCase().contains("lecture") &&
                            ...
                            if (m.getStudentNum() > roomMinTotStudentNum) {
                                ...
                                if (count > 1 && groupAssignedMoreThanOneRoom == true) {
                                    ...
                                    /*System.out.printf("  As room(s) assigned to the tutorial/practical group(s) can " +
                                            "only accommodate %d students. Larger room(s) should be found to " +
                                            "replace the smaller one(s).\n", roomMinTotStudentNum);*/
